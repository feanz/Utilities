...
namespace Utilities
{
    ...
    public class Messages : IMessages
    {
        ...
        {
            if (_messageMap.IsNull()) _messageMap = new Dictionary<string, string>();
        ...
        {
            if (_messageList.IsNull()) _messageList = new List<string>();
        ...
        /// <summary>
        ///   Iterates over the error map and error list and calls the callback. Errormap entries are combined.
        /// </summary>
        /// <param name="callback"> The callback. </param>
        ...
        {
            if (_messageList.IsNull()) return null;
