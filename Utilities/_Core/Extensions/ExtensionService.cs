...
namespace Utilities
{
    ...
    public class ExtensionService<TAttrib, TExtension> where TAttrib : ExtensionAttribute
    {
        ...
        /// </summary>
        protected string _defaultAssemblyForExtensions = "Utilities";
        ...
        /// <summary>
        ///   Callback method for when a single extension has been found in the dll and before it gets registered in the service.
        /// </summary>
        ...
        /// </summary>
        public IDictionary<string, ExtensionMetaData> Lookup
        {
            get { return _lookup; }
        }
        ...
        public virtual TExtension Create(string name)
        {
            ...
            if (metadata.Lamda != null)
                throw new InvalidOperationException(
                    "Can not create instance of extension since it's registered as a lamda");

            Assembly assembly;
            Type type;
            if (metadata.Attribute.IsReusable)
            {
                if (metadata.Instance.IsNull())
                {
        ...
        public virtual void Load(string assembliesDelimited)
        {
            ...
            foreach (var assemblyname in assemblies)
            {
                ...
                Attributes.GetClassAttributesFromAssembly<TAttrib>(assemblyname, (pair) =>
                                                                                     {
                                                                                         pair.Value.
                                                                                             DeclaringType
                                                                                             =
        ...
        /// <summary>
        ///   Gets a items of all the extensions and their descriptions.
        /// </summary>
        /// <returns> </returns>
        public string GetList(string template = null, Func<ExtensionAttribute, bool> filter = null)
        {
            ...
            {
                if (filter.IsNull() || filter(pair.Value.Attribute))
                {
        ...
        {
            foreach (var metaInfo in _lookup)
            {
